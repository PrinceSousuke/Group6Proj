...
function AboutUs(){
    return (
        <div className="App">
            ...
            <Nav />
            <p className="App-headers">Ryan Meeks (Game Developer)</p>
            <p className="About-us-paragraphs">I enjoy studying computer science related things, primarily game development and ethical hacking. If I feel good about what I have learned to do so far, I look for something more difficult to learn. When developing an application, I often try to make it work as fluid as I can, sometimes spending too much time.</p>
            <p className="App-headers">Ben Ludolf (Game Developer)</p>
            <p className="About-us-paragraphs">I'm Ben Ludolf, a current student at Neumont College of Computer Science. My life goal is to work remotely and travel. I have many passions including weightlifting, music, and overall just learning new things. A fun fact about me is I can bench two plates or 225 which only 0.075% of humans can do.</p>
            <p className="App-headers">Amber Oliver (Graphic Designer)</p>
            ...
            <p className="App-headers">Damia Sargent (Website Developer)</p>
            <p className="About-us-paragraphs">
